  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="sticky top-0 z-10 bg-background/95 backdrop-blur border-b border-border px-4 py-3 flex items-center justify-between">
        <div>
          <h1 className="text-lg font-semibold text-foreground">Brian's Journal</h1>
      ...
      <div className="px-4 pt-4 pb-24">
        <Tabs defaultValue="morning" className="w-full">
          ...
          <TabsContent value="morning">
            <MorningTab entry={entry} date={date} onSave={save} onDebouncedSave={debouncedSave} />
          </TabsContent>

          <TabsContent value="midday">
            <MiddayTab entry={entry} date={date} onSave={save} onDebouncedSave={debouncedSave} />
          </TabsContent>

          <TabsContent value="evening">
            <EveningTab entry={entry} date={date} onSave={save} onDebouncedSave={debouncedSave} />
          </TabsContent>
        </Tabs>
      </div>
    </div>
